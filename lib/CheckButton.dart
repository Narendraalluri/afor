...
class CheckButton extends StatefulWidget {
  CheckButton({Key key, this.enable, this.checkSuccess, this.onTap})
      : super(key: key);
...
class _CheckButtonState extends State<CheckButton>
  ...
  void initState() {
    ...
    checkMarkAnimationController =
        AnimationController(vsync: this, duration: Duration(milliseconds: 300));
    buttonSqueezeAnimation = Tween(
      begin: 320.0,
      end: 60.0,
    ).animate(CurvedAnimation(
        parent: buttonAnimationController, curve: Interval(0.0, 0.250)));
    ...
    return GestureDetector(
        ...
        child: Align(
          ...
          child: Container(
              ...
              width: widget.checkSuccess == CHECK_STATUS.INITIAL
                  ? 320.0
              ...
              decoration: BoxDecoration(
                color: widget.enable
                    ...
                    : widget.checkSuccess == CHECK_STATUS.SUCCESS
                        ? Colors.green
                        : Colors.grey,
                borderRadius: BorderRadius.all(Radius.circular(30.0)),
              ),
              child: widget.checkSuccess == CHECK_STATUS.INITIAL
                  ? Text(
                      "Check",
                      style: TextStyle(
                        color: Colors.white,
                  ...
                  : IconTheme(
                      data: IconThemeData(
                          ...
                          size: 40.0,
                          color: Colors.white),
                      child: widget.checkSuccess == CHECK_STATUS.SUCCESS
                          ? Icon(Icons.check)
                          : Icon(Icons.close),
                    )),
        ));
